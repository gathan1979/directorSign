<?php
		...
		$file1 = $_SERVER['DOCUMENT_ROOT'].'\directorSign\uploads\\'.iconv("UTF-8", "UTF-8",$row2['filename']);
		if (file_exists($file1)){
			echo "uploads/".$row2['filename'];
		}
		else{
			//echo "//10.142.49.10/externaldisk/".$row2['filename'];
			echo "//".$_SESSION['server_address']."/externaldisk/directorSign/".$row2['filename'];
		}
