		...
		<div id="container" class="container-fluid">
			...
			<br><span class="label label-default">Έγγραφα για ψηφιακή υπογραφή</span><br><br>
				...
				<div id="demo" class="collapse">
					...
					<div class="col-md-12" id="viewSelectedFiles" style="padding-bottom:20px;"></div>
					<div class="row" >
						<div class="col-md-2" >
							<label for="uname">Σχόλια: </label>
						</div>
						<div class="col-md">
				...
				<?php	  
					  ...
					  while ($row = mysqli_fetch_array($rslt, MYSQLI_BOTH)){
							...
							//preview last upload
								...
								echo '<a href="\directorSign\uploads\\'.$row['filename'].'" target="_blank">'.$row['filename'].'</a>&nbsp<i  class="fas fa-search-plus" title="προεπισκόπηση τελευταίας τροποποίησης εγγράφου" onclick="preview_PDF(\''.$preview_file_last.'\','.$row['aa'].');"></i>&nbsp&nbsp&nbsp-&nbsp&nbsp&nbsp<i  class="fas fa-book" title="προεπισκόπηση αρχικού εγγράφου" onclick="preview_PDF(\''.$preview_file.'\');"></i>'.$relevantDocsElement.'</td><td class="text-right">';
