<?php
		...
		echo " --2";
		$command = 'java -jar "C:\Program Files (x86)\JSignPdf\JSignPdf.jar" "C:\xampp\htdocs\directorSign\uploads\\'.iconv("UTF-8", "UTF-8",$arg2).'" -a  -ka "'.$_SESSION['signature'].'" -kst WINDOWS-MY  --tsa-server-url http://timestamp.ermis.gov.gr/TSS/HttpTspServer --tsa-policy-oid 1.3.6.1.4.1.601.10.3.1 -d "uploads\\"';
		echo $command;
		exec($command,$output2);
		echo "2.5 ".var_dump($output2);
