<?php
		...
		$file1 = $_SERVER['DOCUMENT_ROOT'].'\directorSign\uploads\\'.$_POST['file']; 
		...
		if (file_exists($file1)){
			echo "uploads/".$_POST['file'];
		}
		else{
			//echo "//10.142.49.10/externaldisk/".$_POST['file'];
			echo "//".$_SESSION['server_address']."/externaldisk/directorSign/".$_POST['file'];
		}
