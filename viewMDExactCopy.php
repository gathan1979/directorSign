<?php
		...
		$file2 = $_SERVER['DOCUMENT_ROOT'].'\directorSign\uploads\\'.iconv("UTF-8", "UTF-8",$path_parts['filename']).'_MD_Exact_Copy.pdf';
		if (file_exists($file2)){
			echo "uploads/".$path_parts['filename'].'_MD_Exact_Copy.pdf';
		}
		else{
			//echo "//10.142.49.10/externaldisk/".$path_parts['filename'].'_MD_Exact_Copy.pdf';
			echo "//".$_SESSION['server_address']."/externaldisk/directorSign/".$path_parts['filename'].'_MD_Exact_Copy.pdf';
		}
