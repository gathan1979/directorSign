   ...
   <body tabindex="1" class="loadingInProgress"  >
    <div id="outerContainer">
      ...
      <div id="mainContainer">
        ...
        <div class="toolbar">
          <div id="toolbarContainer">
            <div id="toolbarViewer">
             ...
             <div id="toolbarViewerMiddle" <?php if ($_SESSION['accessLevel']<>1) {echo 'style="pointer-events :none; opacity:0.4;"';}?>>
                <div class="splitToolbarButton">
        ...
        <div id="viewerContainer" tabindex="0" onclick="clickPosition(event)" style=" overflow-y: hidden;">
