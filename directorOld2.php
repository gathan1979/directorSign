							...
							if ($row1!=NULL){      //arxeio me allages
								if($row1['nextLevel']==3){
									...
									if ($_SESSION['accessLevel']>"1"){	
										echo "<a class='showModal' href='http://".$_SERVER['SERVER_ADDR']."/directorSign/signature.php?aa=".$row['aa']."'><span class='glyphicon glyphicon-tag' style='font-size: 20px;' aria-hidden='true' data-toggle='tooltip' title='Ψηφιακή Υπογραφή'></a>&nbsp&nbsp&nbsp&nbsp";
